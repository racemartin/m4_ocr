...
| **3. MOD** | `03_RC_Modelisation_XGB.ipynb` | Entraînement XGBoost | processed | `models/attrition_v1.pkl` |
| **4. SHAP** | `04_RC_Interpretation_SHAP.ipynb` | **Causes du Turnover** | model | Reports/Figures |
